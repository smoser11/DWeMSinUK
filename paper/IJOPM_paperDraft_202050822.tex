...
\usepackage[
backend=biber,
style=authoryear,      % Change style here: apa, chicago, numeric...
sorting=nyt,           % Name, Year, Title sorting
maxcitenames=2,        % Truncate long author lists
natbib=true
]{biblatex}
\addbibresource{references.bib}
\addbibresource{MyLibrary2025-08-22.bib}
\usepackage{amsthm}
\usepackage{amsmath}
\usepackage{amsfonts}
\usepackage{amssymb}
...
(\citeproc{ref-european_union_for_fundamental_rights_severe_2015}{2015}),
...
(Organization et al.
(\citeproc{ref-international_labour_organization_global_2022}{2022})).{[}\^{}CE:
IS THIS THE CORRECT REFERENCE?{]} According to Bonnet et al.
(\citeproc{ref-bonnet_domestic_2022}{2022}), eighty percent of this
...
(Organization et al.
(\citeproc{ref-international_labour_organization_global_2022}{2022})).
...
(\citeproc{ref-international_labour_organization_global_2022}{Organization
et al., 2022}). The ILO suggest that female domestic workers may be
...
began (\citeproc{ref-home_office_modern_2025}{Office, 2025}). In 2024,
...
(\citeproc{ref-mantouvalou_modern_2016}{2016}); Service
(\citeproc{ref-latin_american_womens_rights_service_behind_2023}{2023})),
...
(\citeproc{ref-oconnell_davidson_margins_2015}{2015}); Gutierrez-Huerter
O et al. (\citeproc{ref-gutierrez-huerter_o_change_2023}{2023})). For
this reason, we used the International Labour Organization's (I.L.O.
(\citeproc{ref-ILO11-indicators}{2012})){[}\^{}CE: No idea if this is
...
(Commission (\citeproc{ref-european_commission_staff_2012}{2012})). In
...
(\citeproc{ref-home_office_why_2023}{2023})). These domestic workers
...
the ILO's Indicators (I.L.O. (\citeproc{ref-ILO11-indicators}{2012})).
...
(\citeproc{ref-wang_respondent-driven_2005}{2005}); Abdul-Quader et al.
(\citeproc{ref-abdul-quader_effectiveness_2006}{2006}); Singer \&
...
(\citeproc{ref-ILO11-indicators}{2012})). If the estimates resulting
...
\bibitem[\citeproctext]{ref-abdul-quader_effectiveness_2006}
...
\bibitem[\citeproctext]{ref-european_commission_staff_2012}
...
\bibitem[\citeproctext]{ref-european_union_for_fundamental_rights_severe_2015}
...
\bibitem[\citeproctext]{ref-gutierrez-huerter_o_change_2023}
...
\bibitem[\citeproctext]{ref-oconnell_davidson_margins_2015}
O'Connell Davidson, J. (2015). \emph{The margins of freedom: Modern
slavery}. Palgrave.

\bibitem[\citeproctext]{ref-home_office_why_2023}
...
\bibitem[\citeproctext]{ref-home_office_modern_2025}
...
\bibitem[\citeproctext]{ref-international_labour_organization_global_2022}
...
\bibitem[\citeproctext]{ref-latin_american_womens_rights_service_behind_2023}
