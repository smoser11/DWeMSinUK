...
@tbl-composite lists each of the eleven ILO categories that enter the composite alongside the survey items used to code them, the coding rules, and the maximum weight per category. Categories 12 and 13 are shown at the bottom of the table for completeness but do not enter the composite score.
