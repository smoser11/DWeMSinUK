...
format:
  html:
    ...
    # include-after-body: expand-code.html
  docx:
    toc: true
    toc-depth: 3
...
# Online Appendix {.unnumbered .unlisted}
...
# Section A: Variable Codebook and Indicator Definitions {#sec-a}
...
## A.1 Composite Risk Index {#sec-a-1}
...
## A.2 Five Binary Exploitation Indicators {#sec-a-2}
...
[**Table A2.** Five Binary Exploitation Indicators: ILO classification, survey questions, and coding rules.]{#tbl-a2}
...
## A.3 Key RDS Variables {#sec-a-3}

[**Table A3.** Key RDS Variables: variable name, type, definition, and survey source.]{#tbl-a3}
...
# Section B: Survey Questions and Comparable Ego/Alter Indicators {#sec-b}
...
## B.1 Document Withholding {#sec-b-1}
...
## B.4 Excessive Working Hours {#sec-b-4}
...
## B.5 Limited Access to Help {#sec-b-5}
...
# Section C: Three-Step Bootstrap Procedure {#sec-c}
...
## D.1 Population Size and Invariance of Prevalence {#sec-d-1}
...
## D.2 Supporting Estimates: Bayesian Model-Assisted RDS (MA-RDS) {#sec-d-2}
...
## D.3 Supporting Estimates: RDS-I and RDS-SS Comparison {#sec-d-3}
...
## D.4 Supporting Estimates: NSUM under Alternative Adjustment-Factor Tiers {#sec-d-4}
...
## D.5 Continuous-$\tau$ NSUM Sensitivity Sweep {#sec-d-5}
...
## D.6 Robustness: Bootstrap Method and Weighting Scheme {#sec-d-6}
...
## D.7 Survey Incentive Design {#sec-d-7}
...
## D.8 Leave-One-Out Chain Sensitivity {#sec-d-8}
