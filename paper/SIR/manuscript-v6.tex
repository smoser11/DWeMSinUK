...
\autocite{ILO11-indicators,international_labour_organization_global_2017,int25-ilo}
...
across categories. We conduct robustness assessment by perturbing the
weights (Section~\ref{sec-weights-sensitivity}). Two further evidentiary
...
participating civil-society organisations (Kalayaan, Voice of Domestic
Workers, and the Latin American Women's Rights Service), whose case-work
practice informed item wording and indicator coverage. (3)
