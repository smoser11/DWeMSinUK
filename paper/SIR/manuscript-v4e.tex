...
indicators arranged hierarchically by severity. Section 3 describes the
matched-instrument survey design (Section~\ref{sec-study-design}) and
the dual sampling approach combining RDS and NSUM
(Section~\ref{sec-survey-instrument}). Section 4 presents prevalence
estimates by indicator and method, including frequentist
RDS-I/RDS-II/RDS-SS estimators (Section~\ref{sec-descriptive}), Bayesian
Model-Assisted inference (Section~\ref{sec-composite-results}), and NSUM
with sensitivity analysis (Section 4.3). Section 5 reads the RDS-NSUM
divergence as diagnostic evidence about visibility within workers'
personal networks and discusses implications for SDG 8.7 monitoring.
...
framework for our measurement strategy.
...
Section~\ref{sec-composite-results} and ESM\_4).
...
with the discrete-tier NSUM literature (Killworth et al.~1998; Maltiel
et al.~2015; Feehan and Salganik 2016), we report three reference
...
Posterior intervals are from Bayesian Model-Assisted inference (Gile \&
Handcock, 2015) at N=50,000 with seed.selection=`degree'. Source:
Authors' own work.}
...
indicator set is anchored in the ILO (2012, 2017) framework of forced
labour, with the mapping from indicator to survey question documented in
Section~\ref{sec-survey-instrument} (Table~\ref{tbl-indicator-mapping})
and ESM\_1. (2) \emph{Face validity:} the survey instrument was
co-developed with the participating civil-society organisations
(Kalayaan and the Latin American Women's Rights Service), whose
case-work practice informed item wording and indicator coverage. (3)
\emph{Convergent and diagnostic validity:} the four estimators target
related-but-distinct population quantities and nonetheless reproduce the
same within-method ordering of indicators across methodologically
unrelated approaches (Section~\ref{sec-sensitivity}); the
order-of-magnitude divergence in absolute level between RDS and NSUM, by
contrast, has diagnostic rather than convergent value, telling us about
the visibility structure of each behaviour
(Section~\ref{sec-divergence}). (4) \emph{Robustness:} the
...
the NSUM transmission-bias literature (Killworth et al.~1998; Maltiel et
al.~2015; Feehan and Salganik 2016), which documents systematic alter
under-reporting for stigmatised traits, often of an order of magnitude.
...
\url{https://doi.org/10.1111/irj.12382}.
...
\url{https://doi.org/10.1111/bjir.12308}.
...
Available at: \url{https://doi.org/10.1163/2210-7975_HRD-9992-2016018}.
...
at: \url{https://doi.org/10.1198/jasa.2011.ap09475}.
...
\url{https://doi.org/10.1111/j.1467-9531.2010.01223.x.}
...
pp.~619--639. Available at: \url{https://doi.org/10.1111/rssa.12091}.
...
\url{https://doi.org/10.1214/14-EJS923}.
...
pp.~174--199. Available at: \url{https://doi.org/10.2307/3096941}.
...
Available at:
\url{https://normlex.ilo.org/dyn/nrmlx_en/f?p=NORMLEXPUB:55:0::NO::P55_TYPE\%2CP55_LANG\%2CP55_DOCUMENT\%2CP55_NODE:SUP\%2Cen\%2CC189\%2C\%2FDocument}
(Accessed: 19 December 2025).

ILO (2012) `ILO indicators of forced labour'. Available at:
...
H.R. (1998) `A social network approach to estimating seroprevalence in
the United States', \emph{Social Networks}, 20(1), pp.~23--50. Available
at: \url{https://doi.org/10.1016/S0378-8733(96)00305-X}.
...
Maltiel, R., Raftery, A.E., McCormick, T.H. and Baraff, A.J. (2015)
`Estimating population size using the network scale up method',
\emph{The Annals of Applied Statistics}, 9(3), pp.~1247--1277.
...
\url{https://www.jstor.org/stable/23214188} (Accessed: 25 April 2023).
...
\url{https://doi.org/10.1108/SCM-06-2015-0201}.
...
\url{https://doi.org/10.1111/j.0081-1750.2004.00152.x}.
...
at: \url{https://doi.org/10.1108/SCM-11-2017-0382}.
...
\url{https://www.jstor.org/stable/45390479} (Accessed: 3 November 2025).
...
Yilmaz, S. and Emberson, C. (2023) \emph{Exploring the nature of labour
exploitation among domestic workers in the UK}. Report.
