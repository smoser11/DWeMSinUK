...
: Preferred Prevalence Estimates for the Five Binary ILO-Aligned
Indicators (UK Domestic Workers, N = 980,000). RDS-SS columns from
neighbourhood-bootstrap 95\% CIs (B = 1000); MBSU NSUM (Moderate:
\(\delta = 0.9\), \(\tau = 0.85\)) columns from neighbourhood-bootstrap
95\% CIs. Indicators ordered from highest to lowest ILO severity (strong
\(\rightarrow\) medium). Source: Authors' own work.
