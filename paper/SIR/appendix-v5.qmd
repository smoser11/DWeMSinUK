...
![Figure A5. Leave-One-Out Chain Sensitivity. RDS-SS point estimates and neighbourhood-bootstrap 95% confidence intervals for the five exploitation indicators in the full sample (n = 85) and in the LOO sample with seed #55's chain excluded (n = 73). N = 980,000. Source: Authors' own work.](figures/figA5_loo_chain.png){#figA5_loo_chain width="6in"}
