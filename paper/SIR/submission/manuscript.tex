...
\textbf{Funding.} {[}Funding source anonymised for review; details on
Title Page.{]}
...
mirror: \textless{[}OSF view-only URL redacted for anonymised review;
will be provided upon request{]}\textgreater. The underlying GitHub
repository is currently private and will be made public on acceptance.
