...
(Section~\ref{sec-composite-results}; Appendix Table A.1, Categories 1
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.2639}}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1111}}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1111}}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0417}}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0694}}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0833}}
...
\toprule\noalign{}
\multicolumn{2}{@{}>{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.3750} + 2\tabcolsep}}{%
\begin{minipage}[b]{\linewidth}\raggedright
Nationality cluster
\end{minipage}} &
\multicolumn{6}{>{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.4583} + 10\tabcolsep}@{}}{%
\begin{minipage}[b]{\linewidth}\centering
Wave 0 \textbar{} Wave 1 \textbar{} Wave 2 (seeds) \textbar{} \textbar{}
\end{minipage}} \\
\midrule\noalign{}
\endfirsthead
\toprule\noalign{}
...
\textbf{Total}} &
\multicolumn{6}{>{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.4583} + 10\tabcolsep}@{}}{%
\textbf{46} \textbar{} \textbf{25} \textbar{} \textbf{11}} \\
\end{longtable}
...
Section~\ref{sec-composite-results} and the Appendix D.2).
...
Appendix Figure D.4); the Moderate discrete-tier point estimate
...
per-method bootstrap 95\% CIs (Appendix Table D.3); RDS-I runs
...
Moderate, Conservative; Appendix Table D.4), presented for direct
