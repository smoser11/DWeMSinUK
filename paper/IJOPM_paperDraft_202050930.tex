...
\textbar{} Subgroup \textbar{} Document withholding \textbar{}
Pay-related issues \textbar{} Threats/abuse \textbar{} Excessive hours
\textbar{} Limited access to help \textbar{}
\textbar----------------\textbar----------------------\textbar--------------------\textbar------------
----\textbar-----------------\textbar------------------------\textbar{}
\textbar{} Overall sample \textbar{} 0.1\% (0--0.7) \textbar{} 0.2\%
(0--1.4) \textbar{} 0.2\% (0--1.7) \textbar{} 0.3\% (0--2.4) \textbar{}
0.1\% (0--1.4) \textbar{} \textbar{} Filipino \textbar{} 0.4\% (0--3.2)
\textbar{} 0.9\% (0.1--5.1) \textbar{} 1.0\% (0.1--8.4) \textbar{} 1.3\%
(0.1--9.5) \textbar{} 0.7\% (0.1--7.9) \textbar{} \textbar{} Latinx
\textbar{} 0.1\% (0--0.8) \textbar{} 0.2\% (0--2.2) \textbar{} 0.2\%
(0--2.0) \textbar{} 0.3\% (0--3.8) \textbar{} 0.1\% (0--1.2) \textbar{}
\textbar{} Other Combined \textbar{} 0.0\% (0--0.3) \textbar{} 0.1\%
(0--1.0) \textbar{} 0.1\% (0--1.4) \textbar{} 0.1\% (0--1.2) \textbar{}
0.1\% (0--1.5) \textbar{}
...
estimates using the Clustered SS-PSE methodology. \#\#\#\# RDS Estimates
...
\textcite{netclust21-ljgamble}): - Introduces cluster proportion
parameters (π\_i = N\_i/N) - Jointly estimates population size and
cluster proportions - Uses Dirichlet priors for cluster proportions -
...
Using netclust allows you to: - Account for nationality-based network
clustering - Obtain valid population size estimates for each group -
...
\caption{\label{tab:netclust-analysis}Clustered SS-PSE prevalence estimates by
...
Document
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Document withholding}}\\
\hspace{1em}\cellcolor{gray!10}{withholding} & \cellcolor{gray!10}{|Overall sample} & \cellcolor{gray!10}{|              0.} & \cellcolor{gray!10}{| (0.0–0.7}\\
Document
\hspace{1em}withholding & |Filipino & |              0. & | (0.0–3.2\\
Document
\hspace{1em}\cellcolor{gray!10}{withholding} & \cellcolor{gray!10}{|Latinx} & \cellcolor{gray!10}{|              0.} & \cellcolor{gray!10}{| (0.0–0.8}\\
Document
withholding & |Other
\hspace{1em}Combined & |              0 & 0| (0.0–0.\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Pay-related issues}}\\
\hspace{1em}\cellcolor{gray!10}{Pay-related issues} & \cellcolor{gray!10}{Overall sample} & \cellcolor{gray!10}{0.2} & \cellcolor{gray!10}{(0.0–1.4)}\\
\hspace{1em}Pay-related issues & Filipino & 0.9 & (0.1–5.1)\\
\hspace{1em}\cellcolor{gray!10}{Pay-related issues} & \cellcolor{gray!10}{Latinx} & \cellcolor{gray!10}{0.2} & \cellcolor{gray!10}{(0.0–2.2)}\\
Pay-related issues & Other
\hspace{1em}Combined & |              0. & | (0.0–1.0\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Threats/abuse}}\\
\hspace{1em}\cellcolor{gray!10}{Threats/abuse} & \cellcolor{gray!10}{Overall sample} & \cellcolor{gray!10}{0.2} & \cellcolor{gray!10}{(0.0–1.7)}\\
\hspace{1em}Threats/abuse & Filipino & 1.0 & (0.1–8.4)\\
\hspace{1em}\cellcolor{gray!10}{Threats/abuse} & \cellcolor{gray!10}{Latinx} & \cellcolor{gray!10}{0.2} & \cellcolor{gray!10}{(0.0–2.0)}\\
Threats/abuse & Other
\hspace{1em}Combined & |              0. & | (0.0–1.4\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Excessive hours}}\\
\hspace{1em}\cellcolor{gray!10}{Excessive hours} & \cellcolor{gray!10}{Overall sample} & \cellcolor{gray!10}{0.3} & \cellcolor{gray!10}{(0.0–2.4)}\\
\hspace{1em}Excessive hours & Filipino & 1.3 & (0.1–9.5)\\
\hspace{1em}\cellcolor{gray!10}{Excessive hours} & \cellcolor{gray!10}{Latinx} & \cellcolor{gray!10}{0.3} & \cellcolor{gray!10}{(0.0–3.8)}\\
Excessive hours & Other
\hspace{1em}Combined & |              0. & | (0.0–1.2\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Limited access to help}}\\
\hspace{1em}\cellcolor{gray!10}{Limited access to help} & \cellcolor{gray!10}{Overall sample} & \cellcolor{gray!10}{0.1} & \cellcolor{gray!10}{(0.0–1.4)}\\
\hspace{1em}Limited access to help & Filipino & 0.7 & (0.1–7.9)\\
\hspace{1em}\cellcolor{gray!10}{Limited access to help} & \cellcolor{gray!10}{Latinx} & \cellcolor{gray!10}{0.1} & \cellcolor{gray!10}{(0.0–1.2)}\\
Limited access to help & Other
\hspace{1em}Combined & |              0. & | (0.0–1.5\\
\bottomrule
\multicolumn{4}{l}{\rule{0pt}{1em}\textit{Note: }}\\
\multicolumn{4}{l}{\rule{0pt}{1em}Estimates based on Clustered Sequential Sampling
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{IJOPM_paperDraft_202050930_files/figure-pdf/netclust-analysis-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{IJOPM_paperDraft_202050930_files/figure-pdf/netclust-analysis-2.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{IJOPM_paperDraft_202050930_files/figure-pdf/netclust-analysis-3.pdf}}
...
\caption{\label{tab:netclust-analysis_old}Clustered SS-PSE prevalence estimates for labour
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{IJOPM_paperDraft_202050930_files/figure-pdf/netclust-analysis_old-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{IJOPM_paperDraft_202050930_files/figure-pdf/netclust-analysis_old-2.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{IJOPM_paperDraft_202050930_files/figure-pdf/netclust-analysis_old-3.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{IJOPM_paperDraft_202050930_files/figure-pdf/fig-demographics-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{IJOPM_paperDraft_202050930_files/figure-pdf/netclust-analysis2-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{IJOPM_paperDraft_202050930_files/figure-pdf/netclust-analysis2-2.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{IJOPM_paperDraft_202050930_files/figure-pdf/netclust-analysis2-3.pdf}}
