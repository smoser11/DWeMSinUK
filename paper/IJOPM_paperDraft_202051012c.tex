...
(used for NSUM estimation). See Appendix A for details of these survey
questions and the construction of comparable ego- and alter-based
indicators.
...
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio]{IJOPM_paperDraft_202051012c_files/figure-pdf/fig-rds-network-1.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{IJOPM_paperDraft_202051012c_files/figure-pdf/fig-ma-risk-estimates-1.pdf}
...
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio]{../output/figures/method_comparison.png}
...
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{6cm}>{\raggedleft\arraybackslash}p{5cm}}
\toprule
...
\item \textit{Note:} 
\item Estimates adjusted for RDS sampling bias using Bayesian Model Assisted Inference (Gile \& Handcock, 2015). N=980,000; sample seed selection. Credible intervals from posterior distribution.
\end{tablenotes}
\end{threeparttable}
\endgroup{}
...
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio]{IJOPM_paperDraft_202051012c_files/figure-pdf/fig-ma-binary-forest-1.pdf}
...
\begin{threeparttable}
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{5cm}>{\raggedleft\arraybackslash}p{4cm}>{\raggedleft\arraybackslash}p{4cm}}
\toprule
...
\begin{tablenotes}[para]
\item \textit{Note:} 
\item RDS-I: Salganik-Heckathorn estimator. RDS-SS: Gile's Successive Sampling estimator. Confidence intervals from neighborhood bootstrap (n=1000). Population: 980,000 domestic workers.
\end{tablenotes}
\end{threeparttable}
\endgroup{}
...
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio]{IJOPM_paperDraft_202051012c_files/figure-pdf/fig-rds-forest-plot-1.pdf}
...
\begin{threeparttable}
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{3.5cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{1.8cm}>{\raggedleft\arraybackslash}p{1.8cm}>{\raggedright\arraybackslash}p{2.2cm}}
\toprule
...
\begin{tablenotes}[para]
\item \textit{Note:} 
\item MBSU = Modified Basic Scale-Up method; δ = degree ratio (d̄\_H,F/d̄\_F,F); τ = visibility/true positive rate (v̄\_H,F/d̄\_H,F); Bootstrap: neighborhood resampling (n=1000); Population: 980,000 UK domestic workers.
\end{tablenotes}
\end{threeparttable}
\endgroup{}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{IJOPM_paperDraft_202051012c_files/figure-pdf/fig-rds-sensitivity-popsize-1.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{IJOPM_paperDraft_202051012c_files/figure-pdf/fig-ma-sensitivity-by-indicator-1.pdf}
...
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio]{IJOPM_paperDraft_202051012c_files/figure-pdf/fig-ma-sensitivity-comparison-1.pdf}
