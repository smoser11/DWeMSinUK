...
Second, the Volz–Heckathorn (VH) estimator @volz08-probability offers a probability-based refinement of RDS-I.
...
Third, the Successive Sampling (RDS-SS) estimator (also called RDS-II) @gile11-improved accounts for finite population effects, adjusting for the non-negligible sampling fraction that arises when the target population is not extremely large relative to the sample.
...
Details of the bootstrap implementation and diagnostic checks are provided in Appendix @sec:3step.
...
RDS estimates are anchored in “who recruited whom” and “how many do you know,” while NSUM estimates are anchored in “how many of our alters fit this category.” RDS leverages inclusion probabilities tied to ego network size; NSUM leverages alter reports to extend beyond the sample.
