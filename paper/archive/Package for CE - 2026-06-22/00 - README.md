# Package for Caroline — SIR submission review (22 June 2026)

This folder collects everything needed to review the full SIR-revision pass on the manuscript. The submission-ready manuscript sits in folder 01. Section-by-section redlines (showing what changed at each step) are in folder 02. The rationale memos for each round of edits are in folder 03. The current ESM_4 is in folder 04.
...
### 04 - Supplementary
Current ESM_4 with regenerated figures (the one from the 2026-06-20 Track 1 audit fix pass). Not changed in this revision round — included here so you have the complete submission stack in one place.
