...
\section{Bootstrap-Based Uncertainty Estimation for NSUM with RDS
Samples}\label{bootstrap-based-uncertainty-estimation-for-nsum-with-rds-samples}
...
\subsection{2. The Three-Step Bootstrap
