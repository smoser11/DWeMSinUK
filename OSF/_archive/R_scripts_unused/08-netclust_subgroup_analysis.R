...
# Clustered SS-PSE implementation using netclust package
# (canonical version; formerly 08-netclust_subgroup_analysis_FIXED.R)
...
# Save results
save(final_results, file = here("output", "netclust_subgroup_analysis_results.RData"))
