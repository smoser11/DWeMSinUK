...
# (canonical version; formerly 08b-simple_subgroup_analysis_FIXED.R)
# Uses legitimate RDS estimation methods instead of naive bootstrap
#
# PURPOSE:
...
if (subgroup_config$save_detailed_results) {
  save(rds_subgroup_results, cluster_summary, publication_table1,
       ...
       file = here("output", "rds_subgroup_analysis_results.RData"))
...
cat("Results saved to: output/rds_subgroup_analysis_results.RData\n")
